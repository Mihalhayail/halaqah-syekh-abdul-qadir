...
const programsData = [
  {
    id: "tahfizh",
    icon: BookOpen,
    title: "Tahfizh Al-Qur'an Tathbiqi",
    shortDesc:
      "Program intensif menghafal Al-Qur'an dengan mutqin, dibimbing langsung oleh pengajar bersanad.",
    ...
    target:
      "Penuntut ilmu yang ingin menghafal Al-Qur'an secara intensif dengan bimbingan langsung dari pengajar bersanad.",
  ...
  },
  {
    ...
    shortDesc:
      "Pembelajaran membaca Al-Qur'an dengan metode talaqqi dan musyafahah langsung dari guru.",
  ...
  },
  {
    ...
    shortDesc:
      "Mempelajari ilmu qira'at dan berbagai riwayat bacaan Al-Qur'an yang mutawatir.",
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Program-program unggulan Halaqah Syekh Abdul Qadir"
      />
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Talaqqi",
                desc: "Metode belajar langsung dari mulut guru ke murid, memastikan setiap huruf dan bacaan dipelajari dengan tepat.",
              },
              {
                title: "Musyafahah",
                desc: "Peserta melihat langsung gerakan bibir dan mulut guru saat membaca, sehingga makharijul huruf dapat dipelajari dengan benar.",
              },
              {
                title: "Sanad",
                desc: "Mata rantai keilmuan yang bersambung dari guru ke guru hingga sampai kepada Rasulullah ﷺ, menjamin keaslian bacaan.",
              },
            ].map((method, i) => (
              <motion.div
                key={method.title}
